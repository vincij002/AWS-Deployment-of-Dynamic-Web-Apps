...
# create vpc module
module "vpc" {
  source                       = "git@github.com:vincij002/Terraform-Modules.git//vpc"
  region                       = local.region
...
# create nat-gateways
module "nat_gateway" {
  source                     = "git@github.com:vincij002/Terraform-Modules.git//nat-gateway"
  project_name               = local.project_name
  environment                = local.environment
...
module "security_group" {
  source       = "git@github.com:vincij002/Terraform-Modules.git//security-groups"
  project_name = local.project_name
  environment  = local.environment
  vpc_id       = module.vpc.vpc_id
  ssh_ip       = var.ssh_ip
...
# launch rds instance
module "rds" {
  source                       = "git@github.com:vincij002/Terraform-Modules.git//rds"
  project_name                 = local.project_name
  environment                  = local.environment
  private_data_subnet_az1_id   = module.vpc.private_data_subnet_az1_id
  private_data_subnet_az2_id   = module.vpc.private_data_subnet_az2_id
...
module "ssl_certificate" {
  source            = "git@github.com:vincij002/Terraform-Modules.git//acm"
...
module "alb" {
  source                = "git@github.com:vincij002/Terraform-Modules.git//alb"
  project_name          = local.project_name
  environment           = local.environment
...
# create s3 bucket
module "s3" {
  source               = "git@github.com:vincij002/Terraform-Modules.git//s3"
  project_name         = local.project_name
...
module "ecs_task_execution_role" {
  source               = "git@github.com:vincij002/Terraform-Modules.git//iam-role"
  project_name         = local.project_name
...
module "ecs" {
  source                       = "git@github.com:vincij002/Terraform-Modules.git//ecs"
  project_name                 = local.project_name
  environment                  = local.environment
...
module "ecs_asg" {
  source       = "git@github.com:vincij002/Terraform-Modules.git//asg-ecs"
  project_name = local.project_name
  environment  = local.environment
...
module "route_53" {
  source                             = "git@github.com:vincij002/Terraform-Modules.git//route-53"
